<section id="workshops" data-padding="10">
    <header>
        <h1 class="title-section">warsztaty</h1>
    </header>
    <article class="clearfix">
        ...
        if ( $query->have_posts() ) :
            while ( $query->have_posts() ) : $query->the_post();
                ...
                <div class="workshops-box <?php if($tekst_intro_length) echo "text-collapse "; else echo "pb0 " ?>">
